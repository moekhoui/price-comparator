          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-32 py-4 text-lg border border-orange-300 rounded-2xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all shadow-lg"
                disabled={isLoading}
              />
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4">
              {['iPhone 15', 'Samsung Galaxy S24', 'MacBook Pro M3', 'PlayStation 5', 'Nike Air Max'].map((example) => (
                <button
                  ...
                  className="px-4 py-2 bg-orange-100 hover:bg-orange-200 rounded-full text-sm font-medium transition-colors text-orange-700"
                >
                  {example}
                </button>
              ))}
              ...
              {searchResults.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-600 mb-4">
                    ...
                    <span className="text-orange-600">{item.shipping === 0 ? 'Free Shipping' : `+${formatPrice(item.shipping)}`}</span>
                  </div>
